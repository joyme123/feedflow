...
export function CredentialManager({ open, onClose }: CredentialManagerProps): JSX.Element | null {
  const {
    credentials,
    plugins,
    loadCredentials,
  ...
  }, [open, loadCredentials, loadPlugins])
  ...
  return (
    <Dialog open={open} onClose={onClose} title="凭据管理" width={600}>
